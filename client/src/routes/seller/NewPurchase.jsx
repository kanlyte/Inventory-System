...
class NewPurchase extends Component {
  ...
  handlePurchase = async (e) => {
    ...
    if (this.state.formData.length !== 0) {
      this.state._content["products_purchased"] = this.state.formData;
      this.state._content["user"] = user.username;
      this.state._content["date"] = Date.now();
    }
    console.log(this.state._content.products_purchased);
