...
import data from "../../components/raw-printing";
...
class NewSale extends Component {
  ...
  handleChangeDrugName = (e, v) => {
    ...
    console.log(this.state.active_product_qty);
  };
  ...
  handleSale = async (e) => {
    ...
    if (this.state.formData.length !== 0) {
      this.state._content["products_sold"] = this.state.formData;
    ...
    let res = await api.post("/new_sale", this.state._content);
    if (res.status === true) {
      if (this.state.print) {
                  ...
                  <table width="100%">
                    ...
                    <thead>
                      <tr>
                        ...
                        <td></td>
                        <td>Total</td>
                        <td className="name_cell_a">{`Amount UGX:  ${this.getTotals()}`}</td>
                      </tr>
                    </thead>
                  </table>
                </div>
