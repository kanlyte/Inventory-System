...
import UI_Helper from "../routes/admin/components/format";
          ...
          <div className="print-ctr">
            <div className="print">
              <div className="print-pharmacy">
                <span> AGUBA INVESTMENT LYTE INVENTORY SYSTEM </span>
                <span style={{ fontSize: "20px" }}>
                  Plot 10, Lira University Center.
                </span>
                <span style={{ fontSize: "20px" }}>Tel: 0778089708</span>
              </div>
